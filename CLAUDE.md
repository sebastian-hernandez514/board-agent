...
Antes de cualquier tarea, leer: `docs/AGENT_ARCHITECTURE.md` — tiene el inventario completo de fuentes, las 6 fases, las 17 reglas del Validator, la deuda técnica priorizada y la visión final del sistema.
